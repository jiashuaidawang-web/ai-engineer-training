...
# 指定查询内容
python LocalQwen3.py --query "我的订单ORD001为什么还没发货？"

# 查看帮助信息
python LocalQwen3.py --help
```
...
# 终端 2: 运行智能体系统
python LocalQwen3.py --query "我的订单ORD002的物流状态如何？"
```

#### 方式 3: 交互式运行
```bash
# 启动后会提示输入查询
python LocalQwen3.py --interactive
```
...
```bash
# 查询特定订单
python LocalQwen3.py --query "订单ORD001的状态如何？"

# 查询物流信息
python LocalQwen3.py --query "我的订单ORD002什么时候能到？"

# 启用详细日志
python LocalQwen3.py --query "订单查询" --log-level DEBUG
...
```bash
# 项目启动
python LocalQwen3.py --query "订单查询"

# 开发调试
python LocalQwen3.py --log-level DEBUG
